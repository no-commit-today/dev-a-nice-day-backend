...
import com.nocommittoday.techswipe.batch.domain.subscription.exception.LocalDateParseException;
...
@Component
public class BatchLocalDateParser {

    private final Clock clock;

    public BatchLocalDateParser(Clock clock) {
        this.clock = clock;
    }
